...
export const PART_SYMBOLS = {
  ...
  stile_top_left:      { partId: 'stile_top_left',      symbol: 'STS-L', name: 'Stile Top Sash Left',  group: 'sash', mirror: true  },
  stile_top_right:     { partId: 'stile_top_right',     symbol: 'STS-R', name: 'Stile Top Sash Right', group: 'sash', mirror: true  },
...
const ENGINE_NAME_MAP = {
  ...
  'stiles top sash':         _STL,
  'stiles top sash (l)':     _STL,
  'stiles top sash (r)':     _STR,
